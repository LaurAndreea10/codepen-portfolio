...
[![Projects](https://img.shields.io/badge/Projects-53_live-22c55e?style=for-the-badge&labelColor=071226)](https://laurandreea10.github.io/codepen-portfolio/#projects)
...
> **Portofoliu front-end interactiv** cu 53 de proiecte live, preview instant, filtrare, căutare, mod întunecat/luminos și suport bilingv RO/EN.
...
├── projects.json     # Datele celor 53 de proiecte — editabil separat
...
`projects.json` conține toate cele 53 de proiecte cu titlu, descriere, tags, URL și mini case study în RO și EN. Adăugarea unui proiect nou = un obiect JSON, fără atingerea codului HTML sau JS.
...
> **Interactive front-end portfolio** with 53 live projects, instant preview, filtering, search, dark/light mode and bilingual RO/EN support.
...
├── projects.json     # Data for all 53 projects — editable independently
...
`projects.json` holds all 53 projects with title, description, tags, URL and a bilingual mini case study. Adding a new project = one JSON object, no HTML or JS changes needed.
